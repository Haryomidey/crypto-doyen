...
const Home = () => {
  ...
  return (
    <div className='font-[Quicksand] relative'>
      ...
      <div className={`w-[95%] tablet:w-[50%] max-w-[300px] mx-auto h-72 chat_box_shadow bg-white rounded-md fixed ${!isTrue ? 'bottom-10' : 'bottom-[-50%]'} transition-bottom ease duration-500 right-[50%] tablet:right-[4%] desktop:right-[2%] z-10 translate-x-[50%] tablet:translate-x-0 px-4 py-6`}>
